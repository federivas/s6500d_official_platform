...
public class UniversalDetector
{
    ...
    {
    	if ( this.detectedCharset == null) return null;
        ...
        if (this.inputState == InputState.HIGHBYTE) {
            ...
            for (int i=0; i<this.probers.length; ++i) {
                ...
                if ( proberConfidence > MINIMUM_THRESHOLD ){
	                if ( this.detectedAllCharset==null ) this.detectedAllCharset=this.probers[i].getCharSetName();//
	                else this.detectedAllCharset=this.detectedAllCharset.concat(" "+this.probers[i].getCharSetName());//
                }
            }
